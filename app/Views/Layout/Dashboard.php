...
to-fit=no">
    ...
    <link href="<?php echo base_url(); ?>assets/vendor/fontawesome-
...
accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                <div class="sidebar-brand-text mx-3">Kampus <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo

                                                        base_url('mahasiswa'); ?>">Mahasiswa</a>

                        <a class="collapse-item" href="<?php echo base_url('dosen');
...
800">18</div>
                                        ...
                                        <div class="col-auto">
                                            ...
                                            <i class="fas fa-comments fa-2x text-gray-
300"></i>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url('auth');
...
2.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?>assets/js/demo/chart-area-
demo.js"></script>
